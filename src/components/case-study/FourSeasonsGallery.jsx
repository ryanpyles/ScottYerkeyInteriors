...
const FourSeasonsGallery = () => {
  const { images, isLoading, error, retry } = useSupabaseGallery('four-seasons');
    ...
    return (
      <div className="w-full min-h-screen bg-charcoal flex items-center justify-center">
        ...
        >
          ...
          <p className="text-warm-off-white font-sans text-lg tracking-wide">Loading Four Seasons Gallery...</p>
        </motion.div>
      </div>
    );
  }
      ...
      <div className="w-full min-h-screen bg-charcoal flex items-center justify-center p-6">
        ...
        >
          ...
          <p className="text-lg text-warm-off-white/70 font-sans leading-relaxed">
            Images for the Four Seasons project will be available soon.
          </p>
        </motion.div>
      </div>
    );
...
export default FourSeasonsGallery;