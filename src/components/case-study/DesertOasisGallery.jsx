...
const DesertOasisGallery = () => {
  const { images, isLoading, error, retry } = useSupabaseGallery('desert-oasis');
    ...
    return (
      <div className="w-full min-h-screen bg-charcoal flex items-center justify-center">
        ...
        >
          ...
          <p className="text-warm-off-white font-sans text-lg tracking-wide">Loading Desert Oasis Gallery...</p>
        </motion.div>
      </div>
    );
  }
      ...
      <div className="w-full min-h-screen bg-charcoal flex items-center justify-center p-6">
        ...
        >
          ...
          <p className="text-lg text-warm-off-white/70 font-sans leading-relaxed">
            Images for the Desert Oasis project will be available soon.
          </p>
        </motion.div>
      </div>
    );
...
export default DesertOasisGallery;